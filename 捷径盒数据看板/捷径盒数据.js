...
//*********使用前准备工作*********//
const userId = ' ' //"2778959669" //输入捷径盒userID
...
async function createWidget() {
  ...
  let titleIcon = SFSymbol.named('command.circle.fill')   //  checkmark.seal.fill
  titleIcon.applyMediumWeight()
  let titleIconElement = titleStack.addImage(titleIcon.image)
  titleIconElement.imageSize = new Size(19, 19)
  titleIconElement.tintColor = Color.blue()
  titleStack.addSpacer(8)
  let titleElement = titleStack.addText(`${res.name}`+'·'+`${res.badges[0].title}`)
...
// // // // // // // // // // // // // // 
  ...
  let  bodyElement =  bodyStack.addText(`${res.signature}`)
...
// // // // // // // // // // // // // // 
  ...
  let boltIcon = SFSymbol.named('arrow.down.circle.fill');  //icould.and.arrow.down.fill  bolt.car.fill
  ...
  let boltElement = boltIconStack.addText(`${res.numInstalled}`)
  ...
  let rangeElement = rangeStack.addText(`${res.numBeFollowed}`)
...
// // // // // // // // // // // // // // 
  ...
  let timeToChargeElement = timeToChargeStack.addText(`${res.numShortcuts}`)
...
// // // // // // // // // // // // // // 
  ...
  lastUpdatedElement.leftAlignText();
...
async function getData() {
  ...
  let wakeUrl = 'https://jiejinghe.com/api/users/' + userId
